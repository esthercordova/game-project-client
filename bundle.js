...
/***/ function(module, exports, __webpack_require__) {
	...
	var boardState = void 0;
	var simpleArray = ['', '', '', '', '', '', '', '', ''];
	var activeGame = false;
	var playerMove = 'x';

	var newGameBegin = function newGameBegin() {
	  $('#gameWinner').html('');
	  activeGame = true;
	  boardState = {
	    '0': '', '1': '', '2': '', '3': '', '4': '', '5': '',
	...
	var winner = void 0; //grey is x pink is o
	...
	var endGame = function endGame() {
	  if (winner === 'o' || winner === 'x' || winner === 'tie') {
	    ...
	    api.onEndGame().done(ui.endGame).fail(ui.failure);
	    winner = null;
	    activeGame = false;
	  }
	};
	...
	$(".square").click(function () {
	  ...
	  api.onUpdateGame(index, player, over).done(ui.updateGame).fail(ui.failure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var eventsSignInSuccess = function eventsSignInSuccess(data) {
	  ui.signInSuccess(data);

	  api.getGameByID("").done(ui.getGameSuccess).fail(ui.failure);
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).done(eventsSignInSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateGame = function onUpdateGame(index, player) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var totalGamesWonByX = 0;
	var totalGamesWonByO = 0;
	var totalTies = 0;
	var totalGames = 0;
	...
	// check for tie
	var checkTie = function checkTie(boardState) {
	...
	var checkBoardGame = function checkBoardGame(boardState) {
	  var winner;
	  //row 1
	  if ('' !== boardState['0'] && boardState['0'] === boardState['1'] && boardState['1'] === boardState['2'] && boardState['2'] === boardState['0']) {
	  ...
	  //row 2
	  else if ('' !== boardState['3'] && boardState['3'] === boardState['4'] && boardState['4'] === boardState['5'] && boardState['5'] === boardState['3']) {
	    ...
	    //row 3
	    else if ('' !== boardState['6'] && boardState['6'] === boardState['7'] && boardState['7'] === boardState['8'] && boardState['8'] === boardState['6']) {
	      ...
	      //col 1
	      else if ('' !== boardState['0'] && boardState['0'] === boardState['3'] && boardState['3'] === boardState['6'] && boardState['0'] === boardState['6']) {
	        ...
	        //col 2
	        else if ('' !== boardState['1'] && boardState['1'] === boardState['4'] && boardState['4'] === boardState['7'] && boardState['1'] === boardState['7']) {
	          ...
	          //col 3
	          else if ('' !== boardState['2'] && boardState['2'] === boardState['5'] && boardState['5'] === boardState['8'] && boardState['2'] === boardState['8']) {
	            ...
	            //diagonal 1
	            else if ('' !== boardState['0'] && boardState['0'] === boardState['4'] && boardState['4'] === boardState['8'] && boardState['8'] === boardState['0']) {
	              ...
	              //diagonal 2
	              else if ('' !== boardState['2'] && boardState['2'] === boardState['4'] && boardState['4'] === boardState['6'] && boardState['6'] === boardState['2']) {
	...
	var upDateScoreOnUI = function upDateScoreOnUI(winnerOfGame) {
	...
	module.exports = {
	  ...
	  checkBoardGame: checkBoardGame,
	  upDateScoreOnUI: upDateScoreOnUI,
